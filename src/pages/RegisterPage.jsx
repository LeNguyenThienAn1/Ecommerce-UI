...
const RegisterPage = () => {
  ...
  // Mock register function - replace with your actual logic
          ...
          <div onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              <label className="flex items-start">
                <input
                  type="checkbox"
                  className="h-3 w-3 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded mt-0.5"
                  required
                />
                <span className="ml-2 text-xs text-gray-600 leading-3">
                  I agree to the{' '}
